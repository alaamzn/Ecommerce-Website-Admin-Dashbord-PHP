...
<body>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div>
          ...
          <?php  
            ...
            if(isset($_GET['stockupdated']) && $_GET['stockupdated'] == 'ok'){
                print '<div class="alert alert-success">Stock updated successfully</div>';                
             } 
  ...
  <!-- Modal Edit-->
  <div class="modal fade" id="editModal<?php echo $stock['id'];?>" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">

          <h5 class="modal-title" id="exampleModalLabel">Modifier le stock</h5>
        ...
        <div class="modal-body">
          ...
          <form action="./update_stock.php" method="post">
            ...
            <div class="form-group">
              <label for=""><?php echo $stock['nom'];?></label>
            ...
            <div class="form-group">
              ...
              <input step="1" type="number" name="quantite" class="form-control"value="<?php echo $stock['quantite'];?>"/>
            </div>
